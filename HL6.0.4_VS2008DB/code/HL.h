...
#define WM_START_MSG (WM_USER+70)
...
public:
	...
	BOOL UserLoginCheck(); 
	BOOL GetValidLogicalDrive(CStringArray &arryDisk);
...
protected:
	static unsigned int ThreadCheckInit(LPVOID lpPara);
};
