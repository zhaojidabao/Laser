...
#define DEFAULT_TABCTRLSTYLE		TCS_SINGLELINE|TCS_HOTTRACK|TCS_SCROLLOPPOSITE|TCS_RIGHTJUSTIFY

/////////////////////////////////////////////////////////////////////////////
// COXTabWorkspaceDropTarget drop target for COXTabWorkspace, to faciliate 
// auto-selection on drag over.
class AFX_EXT_CLASS COXTabWorkspaceDropTarget : public COleDropTarget
{
public:
...
class AFX_EXT_CLASS COXTabWorkspace : public CTabCtrl
{
// Construction
public:
	COXTabWorkspace();
...
public:
	...
	void SetOffset(const DWORD dwOffset, BOOL bRecalcLayout=TRUE); 
...
class AFX_EXT_CLASS COXTabClientWnd : public CWnd
{
// Construction
public:
	COXTabClientWnd();
